...
WordPress, your theme, and all plugins should be running the latest versions. Updates fix security holes. Delaying updates is like leaving your shop door unlocked overnight. Learn more in our guide to [why WordPress updates matter](/blog/wordpress-updates-why-matter).

**The catch:** Updates can sometimes break things. That's why we test all updates on a [staging environment](/blog/wordpress-staging-sites) before applying them to live sites.
...
Hackers use automated tools that try thousands of password combinations. Limiting login attempts blocks these "[brute force attacks](/blog/brute-force-attacks-prevention)". Most security plugins include this feature. For even stronger protection, consider adding [two-factor authentication](/blog/two-factor-authentication-wordpress).

### 4. Install a Web Application Firewall (WAF)

A [WAF filters malicious traffic](/blog/wordpress-firewall-guide) before it reaches your site. Cloudflare (free tier) provides basic protection. For serious protection, we use Patchstack which blocks WordPress-specific attacks.

### 5. Back Up Everything

If the worst happens, a recent backup is your get-out-of-jail-free card. Daily backups with at least 7 days retention. Store backups off-site (not on your web server). Read our complete guide to [WordPress backup strategy](/blog/wordpress-backup-strategy).
...
If you think your site has been compromised, follow our step-by-step [malware removal guide](/blog/wordpress-malware-removal-guide).
